...
export async function seedDefaults() {
  ...
  await db.insert(bandeDepensesTable).values([
    ...
    { bandeId: bande.id, designation: "Desinfectant", categorie: "veterinaire", quantite: "1", prixUnitaire: "10000" },
    ...
    { bandeId: bande.id, designation: "Medicaments", categorie: "veterinaire", quantite: "1", prixUnitaire: "220000" },
    ...
    { bandeId: bande.id, designation: "Vaccin", categorie: "veterinaire", quantite: "1", prixUnitaire: "14000" },
